...
def make_withdraw(balance, password):
    ...
    """
    error_attemp = []
    def withdraw(amount, input_key):
        nonlocal balance, error_attemp
        if len(error_attemp) == 3:
            return "Too many incorrect attempts. Attempts: " + str(error_attemp)
        elif password != input_key:
            error_attemp += [input_key]
